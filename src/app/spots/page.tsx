...
const _allSpotsRemoved: Spot[] = [
  {
    ...
    description:
      "Beachfront institution serving authentic Valencian paella since 1898, with sea views and a lively terrace.",
  ...
  },
  {
    ...
    shortCategory: "CAFÉ",
    description:
      "Baroque-style café famous for its Agua de Valencia, chandeliers, and eclectic interior.",
    location: "El Carmen",
    rating: 4.6,
    reviewCount: 1280,
    priceRange: "$$",
  ...
  },
  {
    ...
    description:
      "One of Europe’s largest fresh food markets, housed in a beautiful Modernist building.",
  ...
  },
  {
    ...
    description:
      "Valencian Institute of Modern Art showcasing contemporary exhibitions and cultural events.",
    location: "El Carmen",
    rating: 4.5,
    reviewCount: 980,
    priceRange: "$$",
  ...
  },
  {
    ...
    shortCategory: "CAFÉ",
    description:
      "Historic café serving traditional horchata with fartons in a tiled, picture-perfect interior.",
    location: "Old Town",
    rating: 4.4,
    reviewCount: 1760,
    priceRange: "$",
  ...
  },
  {
    ...
    description:
      "Classic bodega in the Cabanyal district known for its tapas, wine cellar, and authentic atmosphere.",
    location: "Cabanyal",
    rating: 4.7,
    reviewCount: 2100,
    priceRange: "$$",
  ...
  },
  {
    ...
    description:
      "Flagship store of Valencia’s world-famous porcelain brand, showcasing intricate figurines and design pieces.",
  ...
  },
  {
    ...
    shortCategory: "MUSEUM",
    description:
      "Fine arts museum with an impressive collection of Spanish masters, including works by Sorolla.",
    location: "El Carmen",
    rating: 4.6,
    reviewCount: 1560,
    priceRange: "$",
